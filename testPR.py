...
model = fasttext.train_supervised(input="./data/kfold_train_test_data/ft_k10_cve_cwe_summary_clean.train")
...
print(model.test_label("./data/kfold_train_test_data/ft_k10_cve_cwe_summary_clean.train"))